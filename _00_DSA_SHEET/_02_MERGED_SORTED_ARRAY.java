...
public class _02_MERGED_SORTED_ARRAY {
    ...
    public static void MergeSortedArray(int nums1[] , int m ,int nums2[] , int n){
        ...
        // IF THE VALUE OF THE I POINTER FOR THE NUMS1 ARRAY IS BECOMES ZERO THEN WE NEED TO COPY ALL ELEMENTS OF THE NUMS2 ARRAY TO THE NUMS1 ARRAY BY USING THE WHILE LOOP AGAIN AND THIS LOOP TAKES TIME COMPLEXITY OF THE REMAINING ELEMENTS OF THE J.
